...
\begin{frame}
	...
	\begin{figure}
		\centering
		\begin{overprint}
			\onslide<1>\includegraphics[width=\textwidth]{./pictures/create_issue.png}
	...
	\begin{columns}
		...
		\begin{column}{0.6\textwidth}
			\begin{figure}
				\centering
				\begin{overprint}
					\onslide<1>\includegraphics[width=\textwidth]{./pictures/git_branch.png}
	...
	\begin{columns}
		...
		\begin{column}{0.6\textwidth}
			\begin{figure}
				\centering
				\begin{overprint}
					\onslide<1>\includegraphics[width=\textwidth]{./pictures/decimate_unstaged.png}
					\onslide<2>\includegraphics[width=\textwidth]{./pictures/stage_decimate.png}
					\onslide<3>\includegraphics[width=\textwidth]{./pictures/commit_decimate.png}
	...
	\begin{columns}
		...
		\begin{column}{0.6\textwidth}
			\begin{figure}
				\centering
				\begin{overprint}
					\onslide<1>\includegraphics[width=\textwidth]{./pictures/compare_and_pull.png}
					...
					\onslide<4>\includegraphics[width=\textwidth]{./pictures/delete_branch.png}
